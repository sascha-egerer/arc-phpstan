...
final class PhpstanLinter extends ArcanistExternalLinter
{
    ...
    {
        return pht(
            'Install phpstan following the official guide at https://github.com/phpstan/phpstan#installation' .
            'or define the path to the phpstan binary in the config.'
        );
    }
    ...
    public function getLinterConfigurationOptions()
    {
        $options = array(
            ...
            'autoload' => array(
                'type' => 'optional string',
                'help' => pht(
                    'The path to the autoload file. Will be provided as -a <path> to phpstan.'
                ),
            ),
        );
